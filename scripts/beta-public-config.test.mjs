...
const valid={EXPO_PUBLIC_SUPABASE_URL:config.EXPECTED_SUPABASE_URL,EXPO_PUBLIC_SUPABASE_ANON_KEY:'sb_publishable_test_value',EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY:'pk_test_value',EXPO_PUBLIC_RECIPIENT_INVITATION_BASE_URL:'https://beta.kinwin.example'};
...
test('beta public config rejects wrong Supabase, live Stripe, invalid invitation origins, and server secrets',()=>{
