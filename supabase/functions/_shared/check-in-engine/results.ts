// Verbatim copy of domain/challenge/results.ts for the Deno edge-function runtime boundary
...
import { ActivatedChallengeSnapshot, IsoDateTime, SuccessRuleSnapshot } from './types.ts';
import { ChallengePeriod } from './periods.ts';
import { cutBackContinuityCheck } from './check-in/cut-back-continuity.ts';
import { derivePeriodState, EffectivePeriodState } from './check-in/period-state.ts';
import { CheckInEvent } from './check-in/types.ts';
