// Verbatim copy of domain/challenge/check-in/stop-reduction.ts for the Deno edge-function runtime boundary
...
import { CheckInId, IsoDateTime } from '../types.ts';
import { compareIso } from './iso-time.ts';
import { dedupeByOperationId, findOperationIdConflict } from './reduction.ts';
