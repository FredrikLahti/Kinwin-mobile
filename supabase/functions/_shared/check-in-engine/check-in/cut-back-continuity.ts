// Verbatim copy of domain/challenge/check-in/cut-back-continuity.ts for the Deno edge-function runtime boundary
...
import { EffectivePeriodState } from './period-state.ts';
