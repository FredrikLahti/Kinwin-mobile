// Verbatim copy of domain/challenge/check-in/append-plan.ts for the Deno edge-function runtime boundary
...
import { ChallengeId, ChallengePeriodId, CheckInId, IsoDateTime, UserId } from '../types.ts';
...
import { CheckInEvent, CheckInEventType, CheckInFact, CheckInSource, ClientOperationId, factsEqual } from './types.ts';
