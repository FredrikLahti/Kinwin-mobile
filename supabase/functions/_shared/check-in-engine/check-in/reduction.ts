// Verbatim copy of domain/challenge/check-in/reduction.ts for the Deno edge-function runtime boundary
...
import { ChallengePeriodId, CheckInId } from '../types.ts';
import { CheckInEvent, CheckInFact, factsEqual } from './types.ts';
