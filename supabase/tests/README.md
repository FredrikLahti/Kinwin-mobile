...
| `010_seed.sql` | Two owners, one fully activated challenge, one row in every table, and five extra `challenge_drafts` fixtures for `090_prepare_challenge_from_draft.sql` (complete/ready, complete/ready reserved, incomplete/ready, complete/not-ready, complete/ready reserved for the atomicity test), inserted as a trusted party. |
