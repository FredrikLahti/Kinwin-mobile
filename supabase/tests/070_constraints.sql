...
begin
  update private.reward_fulfillments set status='delivered',delivered_at=now(),provider_order_id='order_constraint',provider_reward_id='reward_constraint',provider_status='SUCCEEDED'
