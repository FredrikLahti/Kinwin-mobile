...
- Send one real test password-reset email and confirm the round trip end to end (§1) — the hosted Auth redirect allowlist is now configured, but the actual send-and-click has not been observed.
